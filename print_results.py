...
def print_results(results_dic, results_stats_dic, model, print_incorrect_dogs=False, print_incorrect_breed=False):
    ...
    sum_correct_not_correct_dogs = results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs']

    if print_incorrect_dogs and (sum_correct_not_correct_dogs != results_stats_dic['n_images']):
